      ...
      <div className="px-6 mb-6 relative z-10">
        <div className="grid grid-cols-3 gap-3">
          ...
          <motion.button
            ...
            onClick={openEmail}
            className="flex flex-col items-center gap-2 py-4 rounded-2xl"
            style={{ background: 'rgba(255,175,214,0.1)', border: '1px solid rgba(255,175,214,0.2)' }}
            whileTap={{ scale: 0.95 }}
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.button
            ...
            onClick={openPhone}
            className="flex flex-col items-center gap-2 py-4 rounded-2xl"
            style={{ background: 'rgba(190,204,154,0.1)', border: '1px solid rgba(190,204,154,0.2)' }}
            whileTap={{ scale: 0.95 }}
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
